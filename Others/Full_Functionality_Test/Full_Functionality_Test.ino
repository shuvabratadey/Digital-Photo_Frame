...
#define MIDDLE_BUTTON T4 //(GPIO_13)

#define HAPTIC_MOTOR 26
...
void loop() {
  ...
  Serial.println(touchRead(MIDDLE_BUTTON));
  tft.invertDisplay(state = ! state);
  digitalWrite(HAPTIC_MOTOR, state);
  delay(500);
}
